...
| `reis.fileStore.s3.existingAccessKeySecret`                   | Name of the Kubernetes Secret containing the Bedrock Secret Access Key. The secret must have the keys `s3AccessKeyId` and `s3SecretAccessKey`.           | `""`                                      |
