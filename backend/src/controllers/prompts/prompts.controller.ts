...
export class PromptController {
  ...
  async createPromptCategory(@Body() _createPromptCategoryDto: CreatePromptCategoryDto): Promise<PromptCategoryDto> {
  ...
  async getPromptCategory(@Param('id') _id: number): Promise<PromptCategoryDto> {
    return Promise.resolve(undefined as unknown as PromptCategoryDto);
  }
  ...
  async getPrompt(@Param('id') _id: number): Promise<PromptDto> {
