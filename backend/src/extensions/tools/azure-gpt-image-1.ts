...
export class AzureGPTImage1Extension extends GPTImage1Extension {
  get spec(): ExtensionSpec {
    ...
    return {
      ...
      description: 'Generate images using OpenAI GPT-Image-1.',
      type: 'tool',
      arguments: {
        ...baseSpec.arguments,
        instanceName: {
          type: 'string',
          title: 'Azure OpenAI Instance Name',
          required: true,
        ...
        deploymentName: {
          ...
          required: true,
          description: 'The name of the deployment for GPT-Image-1 model.',
        },
        apiVersion: {
          type: 'string',
          title: 'Azure OpenAI API Version',
          required: true,
          description: 'The API version to use, e.g., 2024-02-15-preview.',
          format: 'select',
