...
@Extension()
export class AzureDictateExtension implements Extension<DictateExtensionConfiguration> {
  ...
  get spec(): ExtensionSpec {
    return {
      ...
      title: this.i18n.t('texts.extensions.dictate.title'),
      ...
      type: 'other',
      description: this.i18n.t('texts.extensions.dictate.description'),
      arguments: {
        apiKey: {
          type: 'string',
          title: this.i18n.t('texts.extensions.dictate.apiKey'),
          required: true,
          format: 'password',
          description: this.i18n.t('texts.extensions.dictate.apiKeyHint'),
        },
        instanceName: {
          type: 'string',
...
export type DictateExtensionConfiguration = ExtensionConfiguration & {
  apiKey: string;
  instanceName: string;
