...
export class VertexAIModelExtension implements Extension<VertexAIModelExtensionConfiguration> {
  ...
  get spec(): ExtensionSpec {
    return {
      ...
      title: this.i18n.t('texts.extensions.vertexai.title'),
      ...
      description: this.i18n.t('texts.extensions.vertexai.description'),
      type: 'llm',
      arguments: {
        modelName: {
          type: 'string',
...
type VertexAIModelExtensionConfiguration = ExtensionConfiguration & { modelName: string };
