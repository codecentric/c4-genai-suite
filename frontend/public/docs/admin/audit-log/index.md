...
The list of changes can be filtered by the assistant affected by the change and the type of changed entity.

Clicking on a row shows which exact change was performed.
