...
function load() {
  return {
    ...
    chat: {
      ...
      dictate: {
        browserNotSupported: translate('chat.dictate.browserNotSupported'),
        microphonePermissionDenied: translate('chat.dictate.microphonePermissionDenied'),
        recordingStartFailed: translate('chat.dictate.recordingStartFailed'),
        noAudioRecorded: translate('chat.dictate.noAudioRecorded'),
        transcriptionFailed: translate('chat.dictate.transcriptionFailed'),
        maxDurationReached: translate('chat.dictate.maxDurationReached'),
        startRecording: translate('chat.dictate.startRecording'),
        stopRecording: translate('chat.dictate.stopRecording'),
        transcribing: translate('chat.dictate.transcribing'),
      },
