...
function load() {
  return {
    ...
    accessibility: {
      ...
      userMenu: translate('accessibility.userMenu'),
      conversationOptions: translate('accessibility.conversationOptions'),
      selectLanguage: translate('accessibility.selectLanguage'),
      toggleChunksInformation: translate('accessibility.toggleChunksInformation'),
      closeDialog: translate('accessibility.closeDialog'),
      storageOptions: translate('accessibility.storageOptions'),
      assistantOptions: translate('accessibility.assistantOptions'),
    },
    chat: {
      ...
      selectAssistant: translate('chat.selectAssistant'),
      searchAssistants: translate('chat.searchAssistants'),
      searchAssistantsPlaceholder: translate('chat.searchAssistantsPlaceholder'),
      configureAssistant: translate('chat.configureAssistant'),
      rating: {
      ...
      localTranscribe: {
        ...
        silenceDetected: translate('chat.localTranscribe.silenceDetected'),
        privacyBadge: translate('chat.localTranscribe.privacyBadge'),
        privacyTooltip: translate('chat.localTranscribe.privacyTooltip'),
        timerLabel: translate('chat.localTranscribe.timerLabel'),
      },
    ...
    auditLog: {
      headline: translate('auditLog.headline'),
      empty: translate('auditLog.empty'),
      entityType: translate('auditLog.entityType'),
      entityId: translate('auditLog.entityId'),
      entityName: translate('auditLog.entityName'),
      action: translate('auditLog.action'),
      user: translate('auditLog.user'),
      timestamp: translate('auditLog.timestamp'),
      extension: translate('auditLog.extension'),
      bucket: translate('auditLog.bucket'),
      configuration: translate('auditLog.configuration'),
      settings: translate('auditLog.settings'),
      userGroup: translate('auditLog.userGroup'),
      create: translate('auditLog.create'),
      update: translate('auditLog.update'),
      delete: translate('auditLog.delete'),
      allTypes: translate('auditLog.allTypes'),
      snapshotDetails: translate('auditLog.snapshotDetails'),
      noPreviousSnapshot: translate('auditLog.noPreviousSnapshot'),
