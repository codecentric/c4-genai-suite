export const en = {
  ...
  accessibility: {
    ...
    toggleChunksInformation: 'Toggle chunks information',
    closeDialog: 'Close dialog',
    storageOptions: 'File storage options',
  ...
  auditLog: {
    ...
    delete: 'Delete',
    allTypes: 'All Types',
    snapshotDetails: 'Change Details',
    noPreviousSnapshot: 'No previous version available to compare.',
